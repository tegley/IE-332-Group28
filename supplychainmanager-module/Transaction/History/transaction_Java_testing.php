        ...
        <div class="col-md-9">
            ...
            <div id="companySection" class="collapse-content">
                ...
                <form class="mt-3">
                    ...
                    <button type="button" class="btn btn-primary mt-3" onclick="runQuery()">Submit</button>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table stats-table">
                            ...
                            <tr>
                                <td><strong>Total Shippings</strong></td>
                                <td id="totalShippingsCell"><!-- JS inserts here --></td>
                            </tr>
...
function runQuery() {
    ...
    // Package User Date range in q
    // q = "startDate,endDate"
    const q = `${start},${end}`;

    // Package User Date range in g
    // g = "LocationType,CompanyName"
    const g = `${locationType},${company}`;

    // Sent AJAX request to PHP file
    fetch(`SCMTransaction_queries_v3.php?q=${q}&g=${g}`)
        .then(response => response.json())
        .then(data => {

            console.log("Received from PHP:", data);

            // Update Total Shippings Cell
            document.getElementById("totalShippingsCell").innerText =
