...
<head>
    ...
    <script src="https://cdn.plot.ly/plotly-2.35.2.min.js" charset="utf-8"></script> <!-- JavaScript for Plotly -->
    ...
    <script src="SCM_display_alerts.js"></script> <!-- JavaScript to display alerts -->
